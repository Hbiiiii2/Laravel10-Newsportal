                       ...
                       <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>
                                        <li><a href="https://www.instagram.com/sobattangsel/" target="_blank"><i class="fab fa-instagram"></i></a> sobattangsel </li>
                                ...
                                <div class="header-info-right">
                                    <ul class="header-social">
                                        ...
                                        <li><a href="https://www.instagram.com/sobattangsel/" target="_blank" ><i style="color: #fff;" class="fab fa-instagram"></i></a></li>
                                        ...
                                        <ul id="navigation">
                                            ...
                                            @auth
                                                ...
                                                <form action="{{ route('logout') }}" method="POST" class="d-inline">
                                                    @csrf
                                                    <button type="submit" class="btn p-1" style="background: none; border: none; color: inherit; font: inherit;">
